...
async function markMetabaseRunCompleted(runId, stats) {
  return updateMetabaseRun(runId, {
    $set: {
      ...
      leadResultsCount: stats.leadResultsCount || 0,
      leadResultsTruncated: stats.leadResultsTruncated === true,
      leadIds: Array.isArray(stats.leadIds) ? stats.leadIds : [],
      queuedLeadIds: Array.isArray(stats.queuedLeadIds) ? stats.queuedLeadIds : [],
      skippedLeadIds: Array.isArray(stats.skippedLeadIds) ? stats.skippedLeadIds : [],
      leadResults: Array.isArray(stats.leadResults) ? stats.leadResults : [],
